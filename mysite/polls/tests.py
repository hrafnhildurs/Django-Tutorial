...
def create_question(question_text, days):
	""" Create a question with the given 'question_text' and pubished
	the given number of 'days' offset too now (negative for questions
